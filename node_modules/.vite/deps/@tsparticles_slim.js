import {
  ...
  mouseLeaveEvent,
  mouseMoveEvent
} from "./chunk-U4BZTIWU.js";
import {
  DestroyType,
  RotateDirection
} from "./chunk-DWTSDWDC.js";
import {
  AnimatableColor,
  AnimationMode,
  AnimationStatus,
...
var BlendPlugin = class {
  ...
  async getPlugin(container) {
    const { BlendPluginInstance } = await import("./BlendPluginInstance-CUNYQ5JM.js");
...
var MovePlugin = class {
  ...
  async getPlugin(container) {
    const { MovePluginInstance } = await import("./MovePluginInstance-PHL465M5.js");
...
var InteractivityPlugin = class {
  ...
  async getPlugin(container) {
    const { InteractivityPluginInstance } = await import("./InteractivityPluginInstance-FWA7F7PE.js");
...
var Grabber = class extends ExternalInteractorBase {
  ...
  interact(interactivityData) {
    ...
    for (const particle of query) {
      ...
      const colorLine = getLinkColor(particle, void 0, container.particles.grabLineColor, container.hdr);
      if (!colorLine) {
        continue;
      }
...
function replaceImageColor(image, imageData, color, particle, hdr = false, peakNits, mode) {
  var _a;
  const svgColoredData = replaceColorSvg(image, color, ((_a = particle.opacity) == null ? void 0 : _a.value) ?? defaultOpacity3, hdr, peakNits, mode), imageRes = {
    color,
    data: {
      ...image,
...
var OverlapPlugin = class {
  ...
  async getPlugin(container) {
    const { OverlapPluginInstance } = await import("./OverlapPluginInstance-BF5MM73L.js");
...
var LinksPlugin = class {
  ...
  async getPlugin(container) {
    const { LinkInstance } = await import("./LinkInstance-CEB64ABK.js");
